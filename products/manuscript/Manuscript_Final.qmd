...
MAYBE ADD IN HERE ON COVARIATES AND TAKE OUT SOME OTHER PARTS.
In this paper, I analyze a unique sample of 2845 recorded clinical visits to Maternidade Laranjeiras between June 1922 and May 1926. [For information on the data processing, exploratory analysis, and final analysis, including all code in R and the open-access dataset, see my Github repository at BLANK. The `Supplemental_Materials` includes information on data processing, exploratory analysis, and model fitting. All materials, including the dataset, are open access and reproducible, with instructions on the schematic of the workflow.] I extracted the sample from Brazil’s major obstetrics and gynecology journal in the first half of the twentieth century, the *Revista de Gynecologia e d’Obstetricia* (RGO). The RGO was associated with the country’s medical association, the National Academy of Medicine (Academia Nacional de Medicina, ANM) and the Brazilian Society of Obstetrics and Gynecology (Sociedade de Obstetricia e Gynecologia do Brasil), both based in Rio de Janeiro. The journal started in August 1907 as the *Revista de Gynecologia e D’Obstetricia do Rio de Janeiro*. In 1919, it changed to the *Revista de Gynecologia, D’Obstetricia e de Pediatria*. In 1922, it became the *Revista de Gynecologia e D’Obstetricia*.

The journal published obstetricians’ and gynecologists’ clinical observations, analyses of new surgical techniques, and ANM proceedings. Between June 1922 and May 1926, RGO also published the monthly clinical reports of all women treated at the Maternidade Laranjeiras. From the available issues, I recorded the following information, when available, for all patients: patient number, parity, skin color, age, nationality, type of delivery ("natural" or vaginal, "interventionist" or requiring some intervention most often forceps, and "operative," or a cesarean section), maternal outcome (death, discharge, transferal to separate hospital), birth outcome (spontaneous abortion, stillbirth or neonatal death, or live birth), and the mother’s reproductive history [I was unable to locate vol. 18, nos. 4, 5, 6, 8 (1924) and vol. 20, no. 4 (1926). For full citations on the journals from which these data came, see @roth2020; @roth2020a].
