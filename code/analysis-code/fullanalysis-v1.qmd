...
```
Performing cross-validation results in an RMSE that is the same as our training model (488), lower than our full model. The r-squared (0.017) is also higher than our training and full models (0.01), demonstrating better model performance.
