...
# Save regression output into table
saveRDS(table2_train, file = here::here("results", "tables", "table2_train.rds"))
...
# Save regression output into table
saveRDS(table2_test, file = here::here("results", "tables", "table2_test.rds"))
...
# Create a gtsummary table directly from the model
table3_train <- pull_workflow_fit(ML_fit2_train) %>%
  tbl_regression(exponentiate = FALSE, intercept = TRUE) %>%
  add_glance_table(include = c(r.squared, adj.r.squared, nobs)) %>%
  modify_column_unhide(columns = c(statistic, std.error)) %>%
  add_significance_stars(hide_ci = FALSE, hide_p = FALSE) %>%
...
# Save regression output into table
saveRDS(table3_train, file = here::here("results", "tables", "table3_train.rds"))
...
# Create a gtsummary table directly from the model
table3_test <- pull_workflow_fit(ML_fit2_test) %>%
  tbl_regression(exponentiate = FALSE, intercept = TRUE) %>%
  add_glance_table(include = c(r.squared, adj.r.squared, nobs)) %>%
  modify_column_unhide(columns = c(statistic, std.error)) %>%
  add_significance_stars(hide_ci = FALSE, hide_p = FALSE) %>%
...
# Save regression output into table
saveRDS(table3_test, file = here::here("results", "tables", "table3_test.rds"))
...
# Create a gtsummary table from model
table4_train <- tbl_regression(ML_fit3_train, exponentiate = FALSE, intercept = TRUE) %>%
  bold_p() %>%
  add_glance_table(include = c(r.squared, adj.r.squared, nobs)) %>%
  modify_column_unhide(columns = c(statistic, std.error)) %>%
  add_significance_stars(hide_ci = FALSE, hide_p = FALSE)
...
# Save regression output into table
saveRDS(table4_train, file = here("results", "tables", "table4_train.rds"))
...
# Create a gtsummary table from model
table4_test <- tbl_regression(ML_fit3_test, exponentiate = FALSE, intercept = TRUE) %>%
  bold_p() %>%
  add_glance_table(include = c(r.squared, adj.r.squared, nobs)) %>%
  modify_column_unhide(columns = c(statistic, std.error)) %>%
  add_significance_stars(hide_ci = FALSE, hide_p = FALSE)
...
# Save regression output into table
saveRDS(table4_test, file = here("results", "tables", "table4_test.rds"))
...
# Create a gtsummary table from model
table5_train <- tbl_regression(ML_fit4_train, exponentiate = FALSE, intercept = TRUE) %>%
  bold_p() %>%
  add_glance_table(include = c(r.squared, adj.r.squared, nobs)) %>%
  modify_column_unhide(columns = c(statistic, std.error)) %>%
  add_significance_stars(hide_ci = FALSE, hide_p = FALSE)
...
# Save regression output into table
saveRDS(table5_train, file = here("results", "tables", "table5_train.rds"))
...
# Create a gtsummary table from model
table5_test <- tbl_regression(ML_fit4_test, exponentiate = FALSE, intercept = TRUE) %>%
  bold_p() %>%
  add_glance_table(include = c(r.squared, adj.r.squared, nobs)) %>%
  modify_column_unhide(columns = c(statistic, std.error)) %>%
  add_significance_stars(hide_ci = FALSE, hide_p = FALSE)
...
# Save regression output into table
saveRDS(table5_test, file = here("results", "tables", "table5_test.rds"))