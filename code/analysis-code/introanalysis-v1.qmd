...
For all three models, the r-squared is very small (0.009, 0.008, and 0.026), indicating that the model does not explain much of the variance in birth weight. This is likely due to the fact that birth weight is a complex trait influenced by many factors, including genetic, environmental, and social factors.
...
# Create a gtsummary table directly from the model
table6 <- tbl_regression(log1_fitted, exponentiate = TRUE) # use exponentiate true for ORs
table6

# Save regression output into table
saveRDS(table6, file = here::here("results", "tables", "table6.rds"))
...
# Create a gtsummary table directly from the model
table7 <- tbl_regression(log2_fitted, exponentiate = TRUE) # use exponentiate true for ORs
table7

# Save regression output into table
saveRDS(table7, file = here::here("results", "tables", "table7.rds"))
...
# Create a gtsummary table directly from the model
table8 <- tbl_regression(log3_fitted, exponentiate = TRUE) # use exponentiate true for ORs
table8 <- bold_p(table8, t = 0.05)
table8

# Save regression output into table
saveRDS(table8, file = here::here("results", "tables", "table8.rds"))
...
# Create a gtsummary table directly from the model
table9 <- tbl_regression(log4_fitted, exponentiate = TRUE) # exponentiate true for ORs

#Bold significant p-values
table9 <- bold_p(table9, t = 0.05)
table9

# Save regression output into table
saveRDS(table9, file = here::here("results", "tables", "table9.rds"))
